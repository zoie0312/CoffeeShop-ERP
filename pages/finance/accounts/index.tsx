...
const AccountsPage: React.FC = () => {
    ...
    const handleViewAccountDetails = (accountId: string) => {
        ...
        // Don't call handleAccountMenuClose here unless it came from the menu
    ...
    return (
        <Layout title="Financial Accounts">
                        ...
                        {filteredAccounts.map((account) => (
                            <Grid item xs={12} sm={6} md={4} key={account.id}>
                                <Card 
                                    ...
                                    onClick={(e) => {
                                        // Only handle the click if it's directly on the card
                                    ...
                                    <CardContent sx={{ flexGrow: 1 }}>
                                        ...
                                        <Stack direction="row" spacing={1} sx={{ mt: 2 }}>
                                            <Button 
                                                ...
                                                variant="outlined"
                                                onClick={(e) => {
                                                    e.stopPropagation(); // Stop propagation to prevent double triggers
                                                    handleViewAccountDetails(account.id);
                                                }}
                                            >
                                                View Details
                ...
                >
                    {selectedAccount && accountDetails ? (
                        ...
                        <>
                            ...
                            <DialogActions>
                                <Button onClick={handleCloseAccountDetails} variant="contained">
                                    Close
                                </Button>
                            </DialogActions>
                        </>
